    ...
    def _get_account_values(self, options, account_ids,
        ...
        if date:
            ...
            if period_fiscal_year:
                ...
                print("where_params[self.find_index(where_params)]  : ",where_params[self.find_index(where_params)] )
                where_params[self.find_index(where_params) + 1] = date_from
                print('where_params[self.find_index(where_params) + 1] : ',where_params[self.find_index(where_params) + 1])

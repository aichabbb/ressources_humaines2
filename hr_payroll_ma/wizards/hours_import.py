...
class Wizard_Hours(models.TransientModel):
   ...
   # @api.multi
    def action_add_hours(self):
        ...
        bulletin_obj = self.env['hr.payroll.ma.bulletin']
        try:
            file_content_decoded = base64.decodebytes(self.file_id)
        except IOError as e:
        ...
        for line in data[1:]:
            ...
            if len(line_data)>1:
                ...
                if not emp_id:
                    ...
                    bulletin = bulletin_obj.search([('id_payroll_ma','=',self.env.context['active_id']),

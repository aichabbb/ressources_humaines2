...
class FinanceSecond(models.Model):
    ...
    def get_lines(self):
        for rec in self:
            ...
            line_26.write({
                'emploi_debut':line_13.emploi_debut + line_23.emploi_debut,
                'ressource_debut':line_13.ressource_debut + line_23.ressource_debut,
                'emploi_fin':line_13.emploi_fin + line_23.emploi_fin,
                'ressource_fin':line_13.ressource_fin + line_23.ressource_fin,
            })
